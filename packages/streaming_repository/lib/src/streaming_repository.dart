...
//       {required StreamingApi streamingApi, required ItemsApi itemsApi, required Database database})
...
//     final category = await _itemsApi.getCategory(parentId: itemId, filter: 'IsNotFolder', fields: 'MediaStreams');
...
//     final backInfos =
//         await _streamingApi.getPlaybackInfos(data, item.id, startTimeTick: item.userData!.playbackPositionTicks);
