...
abstract class Theme {
  ...
  static ThemeData generateDetailsThemeDataFromPaletteColor(List<Color> colors,
    ...
    final onBackground = palette[middleElement].computeLuminance() > 0.5
        ? Colors.black
        : Colors.white;
    if (contastedPage) {
      final themeDataInitial =
          generateThemeDataFromSeedColor(brightness, palette.first);
    ...
    return themeDataInitial
        ...
        .copyWith(
            colorScheme: themeDataInitial.colorScheme
                .copyWith(onBackground: onBackground))
      ..addOwn(
          detailsTheme: DetailsTheme(
        primary: palette[min(0, palette.length - 1)],
        secondary: palette[min(1, palette.length - 1)],
  ...
  static TextTheme generateTextThemeFromBackgroundColor(
