...
class ListItemsHorizontalSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final itemHeight = context.read<CollectionBloc>().horizontalListPosterHeight;
      ...
      child: Align(
        ...
        child: SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: count,
            itemBuilder: (context, index) => SkeletonItemPoster(height: itemHeight, padding: EdgeInsets.only(right: 8)),
          ),
        ),
      ),
    );
