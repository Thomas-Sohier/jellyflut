...
class _GradienButtonState extends State<GradienButton> with AbsorbAction {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return TextButton(
      ...
      ).copyWith(side: buttonBorderSide()).copyWith(elevation: butonElevation()),
      child: customPalette(),
    );
  }
  ...
  WidgetStateProperty<double> butonElevation() {
