...
class _VideoBitrateValueEditorState extends State<VideoBitrateValueEditor> {
  ...
  void editBitrateValue(BuildContext context) async {
    ...
    await showDialog(
      ...
      builder: (c) {
        return AlertDialog(
          title: Text('Edit max video bitrate', style: Theme.of(context).textTheme.titleMedium),
          actions: [
          ...
          content: Column(
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(labelText: 'max_bitrate'.tr(), labelStyle: TextStyle()),
              ),
