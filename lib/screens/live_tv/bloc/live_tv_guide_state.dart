...
class LiveTvGuideState extends Equatable {
  const LiveTvGuideState(
      {this.guide = const <Channel>[],
      this.status = LiveTvGuideStatus.initial,
      this.limit = 100});
  ...
  LiveTvGuideState copyWith(
      {LiveTvGuideStatus? status, List<Channel>? guide, int? limit}) {
