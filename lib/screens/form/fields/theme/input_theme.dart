...
class InputTheme {
  ...
  InputBorder get DEFAULT_BORDER => OutlineInputBorder(
    borderSide: BorderSide(width: 2.0, color: Theme.of(_context).colorScheme.onSurface.withOpacity(0.9)),
  );
  InputBorder get FOCUSED_BORDER =>
      OutlineInputBorder(borderSide: BorderSide(width: 2.0, color: Theme.of(_context).colorScheme.onSurface));
