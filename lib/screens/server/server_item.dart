...
class ServerItem extends StatelessWidget {
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Padding(padding: const EdgeInsets.fromLTRB(24, 4, 24, 4), child: Icon(CommunityMaterialIcons.server)),
                Expanded(
                  child: Column(
  ...
  Widget nbUsers(final BuildContext context) {
    return Text(
      '${serverWithUser.users.length} users',
  ...
  void deleteServer(BuildContext context) {
    ...
    AppDatabase().getDatabase.serversDao
