...
class _ServerParentState extends State<ServerParent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('servers'.tr(), style: Theme.of(context).textTheme.headlineSmall)),
      body: Align(
              ...
              if (snapshot.hasData) {
                return ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return ServerItem(key: ValueKey(serverWithUser), serverWithUser: serverWithUser, isInUse: isInUse);
                  },
                );
