        ...
        children: [
          ...
          Theme(
            data: Theme.of(context).copyWith(
              textTheme: t.Theme.generateTextThemeFromColor(Theme.of(context).dialogTheme.contentTextStyle?.color),
            ),
            child: form(),
          ),
          DecoratedBox(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    onPressed: onClose,
                    style: TextButton.styleFrom(textStyle: TextStyle(color: Theme.of(context).colorScheme.onSecondary)),
                    child: Text('cancel'.tr()),
                  ),
                  const SizedBox(width: 4),
                  TextButton(
                    onPressed: onSubmit,
                    style: TextButton.styleFrom(textStyle: TextStyle(color: Theme.of(context).colorScheme.onTertiary)),
