...
class _LargeBookViewState extends State<LargeBookView> {
    ...
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: Row(
          children: [
            Container(
              color: ColorUtil.lighten(Theme.of(context).colorScheme.surface, 0.1),
              width: 200,
              child: Column(
                children: [
                  SizedBox(
  ...
  Widget pageButtonsBuilder() {
    return StreamBuilder<Map<int, int>>(
      ...
      builder: (context, snapshot) => pageButtons(snapshot.data),
    );
  }
      ...
      child: Row(
        ...
        children: [
          if (pageNumber == currentPage)
            Padding(padding: const EdgeInsets.only(left: 2, right: 2), child: Icon(Icons.check, size: 24)),
