...
import '../models/jellyfin/item.dart' as _i15;
...
import '../screens/iptv/iptv.dart' as _i11;
...
class AppRouter extends _i12.RootStackRouter {
  ...
  List<_i12.RouteConfig> get routes => [
        ...
        _i12.RouteConfig(AuthParentRoute.name, path: 'authentication'),
        _i12.RouteConfig(HomeRouter.name, path: 'home', guards: [
          authGuard
        ], children: [
          _i12.RouteConfig(HomeRoute.name, path: '', parent: HomeRouter.name),
          _i12.RouteConfig(CollectionRoute.name,
              path: 'collection-parent',
              parent: HomeRouter.name,
              guards: [authGuard]),
          _i12.RouteConfig(IptvRoute.name,
        ...
        _i12.RouteConfig(CollectionParentRoute.name,
            path: '/collection-parent', guards: [authGuard]),
        _i12.RouteConfig(DetailsRoute.name,
            path: 'details', guards: [authGuard]),
        _i12.RouteConfig(SettingsRoute.name,
            path: 'settings', guards: [authGuard]),
        _i12.RouteConfig(MusicPlayerRoute.name,
            path: 'music-player', guards: [authGuard]),
        _i12.RouteConfig(PlaylistRoute.name,
            path: 'playlist', guards: [authGuard]),
        _i12.RouteConfig(StreamRoute.name, path: 'stream', guards: [authGuard]),
        _i12.RouteConfig(BookReaderPageRoute.name,
...
/// generated route for
/// [_i1.AuthParent]
class AuthParentRoute extends _i12.PageRouteInfo<AuthParentRouteArgs> {
  AuthParentRoute({_i13.Key? key, void Function()? onAuthenticated})
...
class HomeRouter extends _i12.PageRouteInfo<HomeRouterArgs> {
  HomeRouter({_i13.Key? key, List<_i12.PageRouteInfo>? children})
...
class CollectionParentRoute
    extends _i12.PageRouteInfo<CollectionParentRouteArgs> {
  CollectionParentRoute({required _i15.Item item})
...
class DetailsRoute extends _i12.PageRouteInfo<DetailsRouteArgs> {
  DetailsRoute({required _i15.Item item, required String? heroTag})
...
/// generated route for
/// [_i6.MusicPlayer]
class MusicPlayerRoute extends _i12.PageRouteInfo<MusicPlayerRouteArgs> {
  MusicPlayerRoute({_i13.Key? key})
...
class PlaylistRoute extends _i12.PageRouteInfo<PlaylistRouteArgs> {
  PlaylistRoute({_i13.Key? key, required _i13.Widget body})
...
/// generated route for
/// [_i8.Stream]
class StreamRoute extends _i12.PageRouteInfo<StreamRouteArgs> {
  StreamRoute({_i15.Item? item, String? url})
...
/// generated route for
/// [_i9.BookReaderPage]
class BookReaderPageRoute extends _i12.PageRouteInfo<BookReaderPageRouteArgs> {
  BookReaderPageRoute({_i13.Key? key, required _i15.Item item})
...
class CollectionRoute extends _i12.PageRouteInfo<CollectionRouteArgs> {
  CollectionRoute({required _i15.Item item})
...
/// generated route for
/// [_i11.Iptv]
class IptvRoute extends _i12.PageRouteInfo<IptvRouteArgs> {
  IptvRoute({_i13.Key? key})
