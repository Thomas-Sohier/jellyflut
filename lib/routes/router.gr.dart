...
class DownloadsPage extends _i14.PageRouteInfo<DownloadsPageArgs> {
  DownloadsPage({_i15.Key? key})
      : super(
          DownloadsPage.name,
          path: 'downloads',
          args: DownloadsPageArgs(key: key),
        );
